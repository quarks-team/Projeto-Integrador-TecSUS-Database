...
CREATE TABLE `agua` (
    ...
    `hidrom` varchar(30)  NOT NULL,
    `consu_agua` float(8,2)  NOT NULL,
...
CREATE TABLE `contrato_agua` (
    `contr_agua_id` int  NOT NULL,
    `nome_contr_agua` varchar(50)  NULL,
    `cod_liga_rgi` varchar(50)  NOT NULL,
    `num_instal` varchar(30)  NOT NULL,
...
CREATE TABLE `contrato_energia` (
    ...
    `nome_contr_ener` varchar(50)  NOT NULL,
    `fornece_ener` varchar(30)  NOT NULL,
    `nome_contr_energ` varchar(50)  NULL,
    `num_medidor` varchar(30)  NOT NULL,
    `tensao` float(8,2)  NOT NULL,
    `unid_metric` varchar(4)  NOT NULL,
...
CREATE TABLE `energia` (
    ...
    `num_medidor` varchar(30)  NOT NULL,
    `cosumo_total` float(8,2)  NOT NULL,
...
CREATE TABLE `fato_conta_agua` (
    ...
    `contr_agua` varchar(50)  NOT NULL,
    `total_conta_agua` float(8,2)  NOT NULL,
...
CREATE TABLE `fato_conta_energia` (
    ...
    `contr_ener_id` int  NOT NULL,
    `mes_ref` date  NOT NULL,
    `contr_energ` varchar(50)  NOT NULL,
...
CREATE TABLE `unidade_cliente` (
    ...
    `camp_ext_4` varchar(15)  NOT NULL,
